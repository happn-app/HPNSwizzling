...
/**
 ...
 - Note:
 If `store` is non-`NULL`, it must always point to a valid memory location while the application is launched (unless you don’t plan on fixing children swizzling).
...
/**
 ...
 - Note:
 If store is non-`NULL`, it must always point to a valid memory location while the application is launched
